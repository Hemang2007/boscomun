    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$g, 239, 8, 6673);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment$g(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$g, 217, 4, 5842);
    			attr_dev(div0, "class", "event-title svelte-16v24g0");
    			add_location(div0, file$g, 218, 4, 5896);
    			attr_dev(div1, "class", "logo-container svelte-16v24g0");
    			add_location(div1, file$g, 216, 0, 5808);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
  ...
  `;
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$5, 33, 6, 1008);
    			attr_dev(div, "class", "item svelte-1pfgckf");
    			add_location(div, file$5, 32, 4, 943);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img);
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-1pfgckf");
    			add_location(img, file$5, 42, 6, 1248);
    			attr_dev(div, "class", "item svelte-1pfgckf");
    			add_location(div, file$5, 41, 4, 1182);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-1pfgckf");
    			add_location(img, file$5, 51, 6, 1493);
    			attr_dev(div, "class", "item svelte-1pfgckf");
    			add_location(div, file$5, 50, 4, 1427);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img);
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	let items2 = [
    		...
    		{
    			img: '/schedule.png',
    			pdf: '/pdfs/Conference_Schedule.pdf'
    		}
    	];

    ...
    function create_each_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$e, 62, 8, 4715);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(p, "class", "svelte-4jvnh6");
    			add_location(p, file$e, 70, 8, 4896);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$e, 49, 0, 4176);
    			...
    			add_location(img0, file$e, 54, 8, 4361);
    			attr_dev(div0, "class", "image-container svelte-4jvnh6");
    			add_location(div0, file$e, 53, 6, 4322);
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p7, file$c, 20, 4, 1696);
    			attr_dev(strong5, "class", "highlight svelte-12ue0bz");
    			add_location(strong5, file$c, 22, 7, 1959);
    			attr_dev(p8, "class", "svelte-12ue0bz");
    			add_location(p8, file$c, 22, 4, 1956);
    			add_location(br1, file$c, 23, 4, 2038);
    			attr_dev(strong6, "class", "highlight-underline svelte-12ue0bz");
    			add_location(strong6, file$c, 24, 31, 2075);
    			attr_dev(p9, "class", "address-section svelte-12ue0bz");
    			add_location(p9, file$c, 24, 4, 2048);
    			attr_dev(p10, "class", "svelte-12ue0bz");
    			add_location(p10, file$c, 25, 4, 2152);
    			attr_dev(p11, "class", "svelte-12ue0bz");
    			add_location(p11, file$c, 26, 4, 2507);
    			attr_dev(p12, "class", "svelte-12ue0bz");
    			add_location(p12, file$c, 27, 4, 2952);
    			attr_dev(p13, "class", "svelte-12ue0bz");
    			add_location(p13, file$c, 28, 4, 3118);
    			attr_dev(p14, "class", "svelte-12ue0bz");
    			add_location(p14, file$c, 29, 4, 3369);
    			attr_dev(p15, "class", "svelte-12ue0bz");
    			add_location(p15, file$c, 30, 4, 3634);
    			attr_dev(p16, "class", "svelte-12ue0bz");
    			add_location(p16, file$c, 31, 4, 4031);
    			attr_dev(p17, "class", "svelte-12ue0bz");
    			add_location(p17, file$c, 32, 4, 4194);
    			attr_dev(p18, "class", "svelte-12ue0bz");
    			add_location(p18, file$c, 33, 4, 4847);
    			add_location(br2, file$c, 34, 15, 5284);
    			add_location(br3, file$c, 35, 20, 5310);
    			add_location(br4, file$c, 36, 22, 5338);
    			add_location(br5, file$c, 37, 51, 5395);
    			add_location(br6, file$c, 38, 26, 5427);
    			attr_dev(p19, "class", "svelte-12ue0bz");
    			add_location(p19, file$c, 34, 4, 5273);
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t21 = space();
    			p7 = element("p");
    			p7.textContent = "Emulating the intense deliberations of the All-India Political Parties Meet (AIPPM), the delegates are entrusted with imitating the roles of prominent political leaders of that era, wielding immense power and influence.";
    			t23 = space();
    			p8 = element("p");
    			p8.textContent = "As the delegates engage in diplomatic negotiations amidst the confines of these halls their expertise in the art of politics will be put to the test and with clashing political and religious ideologies, they will craft a path towards unity and peace or will navigate the tumultuous and deceptive waters of political strategy.";
    			t25 = space();
    			p9 = element("p");
    			strong5 = element("strong");
    			strong5.textContent = "Agenda- Addressing the civil and religious tensions in India 19938";
    			t27 = space();
    			br1 = element("br");
    			t28 = space();
    			p10 = element("p");
    			...
    			t46 = space();
    			p19 = element("p");
    			p19.textContent = "This study guide aims to provide some background information on the issues at hand, focusing mainly on religious and civil strife in India in 1993 and the Babri Masjid demolition. It aims to introduce you to the historical background, main occurrences, and various standpoints on these issues.This study guide provides you with the foundation research and for one to excel in committee, your personal research becomes essential and imperative.";
    			t48 = space();
    			p20 = element("p");
    			...
    			attr_dev(p8, "class", "svelte-12ue0bz");
    			add_location(p8, file$b, 23, 4, 1690);
    			attr_dev(strong5, "class", "highlight svelte-12ue0bz");
    			add_location(strong5, file$b, 25, 7, 2037);
    			attr_dev(p9, "class", "svelte-12ue0bz");
    			add_location(p9, file$b, 25, 4, 2034);
    			add_location(br1, file$b, 26, 4, 2149);
    			attr_dev(strong6, "class", "highlight-underline svelte-12ue0bz");
    			add_location(strong6, file$b, 27, 31, 2186);
    			attr_dev(p10, "class", "address-section svelte-12ue0bz");
    			add_location(p10, file$b, 27, 4, 2159);
    			attr_dev(p11, "class", "svelte-12ue0bz");
    			add_location(p11, file$b, 28, 4, 2263);
    			attr_dev(p12, "class", "svelte-12ue0bz");
    			add_location(p12, file$b, 29, 6, 2298);
    			attr_dev(p13, "class", "svelte-12ue0bz");
    			add_location(p13, file$b, 30, 4, 2487);
    			attr_dev(p14, "class", "svelte-12ue0bz");
    			add_location(p14, file$b, 31, 4, 3163);
    			attr_dev(p15, "class", "svelte-12ue0bz");
    			add_location(p15, file$b, 32, 4, 3231);
    			attr_dev(p16, "class", "svelte-12ue0bz");
    			add_location(p16, file$b, 33, 4, 3774);
    			attr_dev(p17, "class", "svelte-12ue0bz");
    			add_location(p17, file$b, 35, 4, 4178);
    			attr_dev(p18, "class", "svelte-12ue0bz");
    			add_location(p18, file$b, 37, 4, 4715);
    			attr_dev(p19, "class", "svelte-12ue0bz");
    			add_location(p19, file$b, 39, 4, 5272);
    			attr_dev(p20, "class", "svelte-12ue0bz");
    			add_location(p20, file$b, 40, 4, 5729);
    			attr_dev(p21, "class", "svelte-12ue0bz");
    			add_location(p21, file$b, 42, 4, 6298);
    			add_location(br2, file$b, 42, 25, 6319);
    			add_location(br3, file$b, 43, 15, 6340);
    			add_location(br4, file$b, 44, 16, 6362);
    			add_location(br5, file$b, 45, 29, 6397);
    			add_location(br6, file$b, 46, 50, 6453);
    			add_location(br7, file$b, 47, 26, 6485);
    			attr_dev(p22, "class", "svelte-12ue0bz");
    			add_location(p22, file$b, 43, 4, 6329);
    			attr_dev(div1, "class", "text-container svelte-12ue0bz");
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p7, "class", "svelte-12ue0bz");
    			add_location(p7, file$a, 21, 4, 1341);
    			attr_dev(strong5, "class", "highlight svelte-12ue0bz");
    			add_location(strong5, file$a, 23, 7, 1928);
    			attr_dev(p8, "class", "svelte-12ue0bz");
    			add_location(p8, file$a, 23, 4, 1925);
    			add_location(br1, file$a, 24, 4, 2001);
    			attr_dev(strong6, "class", "highlight-underline svelte-12ue0bz");
    			add_location(strong6, file$a, 25, 31, 2038);
    			attr_dev(p9, "class", "address-section svelte-12ue0bz");
    			add_location(p9, file$a, 25, 4, 2011);
    			attr_dev(p10, "class", "svelte-12ue0bz");
    			add_location(p10, file$a, 26, 4, 2115);
    			attr_dev(p11, "class", "svelte-12ue0bz");
    			add_location(p11, file$a, 28, 4, 2424);
    			attr_dev(p12, "class", "svelte-12ue0bz");
    			add_location(p12, file$a, 30, 4, 2506);
    			attr_dev(p13, "class", "svelte-12ue0bz");
    			add_location(p13, file$a, 32, 4, 2699);
    			attr_dev(p14, "class", "svelte-12ue0bz");
    			add_location(p14, file$a, 34, 4, 2939);
    			attr_dev(p15, "class", "svelte-12ue0bz");
    			add_location(p15, file$a, 36, 4, 3337);
    			attr_dev(p16, "class", "svelte-12ue0bz");
    			add_location(p16, file$a, 38, 4, 3707);
    			add_location(br2, file$a, 40, 15, 3927);
    			add_location(br3, file$a, 41, 25, 3958);
    			add_location(br4, file$a, 42, 29, 3993);
    			add_location(br5, file$a, 43, 41, 4040);
    			add_location(br6, file$a, 44, 26, 4072);
    			attr_dev(p17, "class", "svelte-12ue0bz");
    			add_location(p17, file$a, 40, 4, 3916);
    			attr_dev(div1, "class", "text-container svelte-12ue0bz");
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t16 = space();
    			p5 = element("p");
    			p5.textContent = "The Association of Southeast Asian Nations (ASEAN) faces yet another complex crisis wherein an intricate understanding of power struggles, dynamism of regional politics as well the wider geopolitical environment.";
    			t18 = space();
    			p6 = element("p");
    			p6.textContent = "This crisis demands influential regional leaders to take centre stage and engage in intense negotiations, diplomatic dialogue, recommend sustainable solutions, and create alliances to tackle the crisis and prevent the escalation of the conflict. With the future of Myanmar and the stability of Southeast Asia hanging in the balance, delegates emulating key political figures will have to navigate the turbulent waters with continued vigilance, negotiation, and foresight, harmonizing their interests with the enduring principles of diplomacy and statesmanship.";
    			t20 = space();
    			p7 = element("p");
    			strong4 = element("strong");
    			...
    			attr_dev(p6, "class", "svelte-12ue0bz");
    			add_location(p6, file$9, 20, 4, 1396);
    			attr_dev(strong4, "class", "highlight svelte-12ue0bz");
    			add_location(strong4, file$9, 22, 7, 1979);
    			attr_dev(p7, "class", "svelte-12ue0bz");
    			add_location(p7, file$9, 22, 4, 1976);
    			add_location(br1, file$9, 23, 4, 2057);
    			attr_dev(strong5, "class", "highlight-underline svelte-12ue0bz");
    			add_location(strong5, file$9, 24, 31, 2094);
    			attr_dev(p8, "class", "address-section svelte-12ue0bz");
    			add_location(p8, file$9, 24, 4, 2067);
    			attr_dev(p9, "class", "svelte-12ue0bz");
    			add_location(p9, file$9, 25, 4, 2171);
    			attr_dev(p10, "class", "svelte-12ue0bz");
    			add_location(p10, file$9, 27, 4, 2210);
    			attr_dev(p11, "class", "svelte-12ue0bz");
    			add_location(p11, file$9, 29, 4, 2450);
    			attr_dev(p12, "class", "svelte-12ue0bz");
    			add_location(p12, file$9, 30, 4, 2527);
    			attr_dev(p13, "class", "svelte-12ue0bz");
    			add_location(p13, file$9, 32, 4, 3301);
    			attr_dev(p14, "class", "svelte-12ue0bz");
    			add_location(p14, file$9, 34, 4, 3653);
    			add_location(br2, file$9, 36, 15, 4792);
    			add_location(br3, file$9, 37, 40, 4838);
    			add_location(br4, file$9, 38, 67, 4911);
    			add_location(br5, file$9, 39, 26, 4943);
    			attr_dev(p15, "class", "svelte-12ue0bz");
    			add_location(p15, file$9, 36, 4, 4781);
    			attr_dev(div1, "class", "text-container svelte-12ue0bz");
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t14 = space();
    			p4 = element("p");
    			p4.textContent = "In the heart of the Arabian world, in the midst of a time of profound change and mounting tensions, the Lebanon Crisis emerged as a pivotal moment in regional history. The crisis was fuelled by internal strife, religious tensions, and the broader geopolitical strains of the Cold War, which threatened to collapse the fragile religious and political equilibrium that held the country together.";
    			t16 = space();
    			p5 = element("p");
    			p5.textContent = "The Arab League, since its conception in 1945 faces a mammoth obstacle before itself in the shape of this crisis. This period calls for an intricate knowledge of regional power dynamics, international influence, and geo-politics. Delegates assuming the roles of key political figures will have the immense trial of navigating the pressing turmoil as well as addressing the underlying roots of the dispute all while keeping in mind how high the stakes are.";
    			t18 = space();
    			p6 = element("p");
    			p6.textContent = "Engage in rigorous debate, propose viable solutions, conduct diplomatic negotiations, and work in tandem to de-escalate the status quo. The stability of the region hangs in the balance find a path to peace or immerse the region in the chaos of war.";
    			t20 = space();
    			p7 = element("p");
    			strong4 = element("strong");
    			...
    			attr_dev(p5, "class", "svelte-12ue0bz");
    			add_location(p5, file$8, 18, 4, 1131);
    			attr_dev(p6, "class", "svelte-12ue0bz");
    			add_location(p6, file$8, 20, 4, 1605);
    			attr_dev(strong4, "class", "highlight svelte-12ue0bz");
    			add_location(strong4, file$8, 22, 7, 1876);
    			attr_dev(p7, "class", "svelte-12ue0bz");
    			add_location(p7, file$8, 22, 4, 1873);
    			add_location(br1, file$8, 23, 4, 1954);
    			attr_dev(strong5, "class", "highlight-underline svelte-12ue0bz");
    			add_location(strong5, file$8, 24, 31, 1991);
    			attr_dev(p8, "class", "address-section svelte-12ue0bz");
    			add_location(p8, file$8, 24, 4, 1964);
    			attr_dev(p9, "class", "svelte-12ue0bz");
    			add_location(p9, file$8, 25, 4, 2068);
    			attr_dev(p10, "class", "svelte-12ue0bz");
    			add_location(p10, file$8, 26, 4, 2105);
    			attr_dev(p11, "class", "svelte-12ue0bz");
    			add_location(p11, file$8, 28, 4, 3074);
    			attr_dev(p12, "class", "svelte-12ue0bz");
    			add_location(p12, file$8, 30, 4, 3158);
    			attr_dev(p13, "class", "svelte-12ue0bz");
    			add_location(p13, file$8, 32, 4, 3915);
    			attr_dev(p14, "class", "svelte-12ue0bz");
    			add_location(p14, file$8, 34, 4, 4564);
    			attr_dev(p15, "class", "svelte-12ue0bz");
    			add_location(p15, file$8, 36, 4, 5059);
    			add_location(br2, file$8, 38, 15, 5529);
    			add_location(br3, file$8, 39, 37, 5572);
    			add_location(br4, file$8, 40, 39, 5617);
    			add_location(br5, file$8, 41, 26, 5649);
    			attr_dev(p16, "class", "svelte-12ue0bz");
    			add_location(p16, file$8, 38, 4, 5518);
    			attr_dev(div1, "class", "text-container svelte-12ue0bz");
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t25 = space();
    			p7 = element("p");
    			p7.textContent = "Devansh Agarwal";
    			t27 = space();
    			p8 = element("p");
    			p8.textContent = "Amay Rathore";
    			t29 = space();
    			p9 = element("p");
    			p9.textContent = "Rohaan Chakraborty";
    			t31 = space();
    			p10 = element("p");
    			...
    			add_location(p8, file$4, 102, 8, 2238);
    			attr_dev(p9, "class", "svelte-1kgx1tt");
    			add_location(p9, file$4, 103, 8, 2267);
    			attr_dev(p10, "class", "svelte-1kgx1tt");
    			add_location(p10, file$4, 104, 8, 2302);
    			attr_dev(p11, "class", "svelte-1kgx1tt");
    			add_location(p11, file$4, 105, 8, 2337);
    			attr_dev(p12, "class", "svelte-1kgx1tt");
    			add_location(p12, file$4, 106, 8, 2366);
    			attr_dev(p13, "class", "svelte-1kgx1tt");
    			add_location(p13, file$4, 107, 8, 2396);
    			attr_dev(p14, "class", "svelte-1kgx1tt");
    			add_location(p14, file$4, 108, 8, 2427);

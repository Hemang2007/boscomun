...
var app = (function () {
    ...
    const file$g = "src\\about\\AboutBoscoMUN.svelte";
    ...
    function create_each_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(t_value);
    			attr_dev(p, "class", "svelte-p61mb1");
    			add_location(p, file$g, 17, 6, 1472);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$g(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "heading svelte-p61mb1");
    			add_location(h1, file$g, 10, 0, 1171);
    			if (!src_url_equal(img.src, img_src_value = /*imageUrl*/ ctx[0])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Devansh");
    			attr_dev(img, "loading", "lazy");
    			attr_dev(img, "class", "svelte-p61mb1");
    			add_location(img, file$g, 13, 4, 1286);
    			attr_dev(div0, "class", "image-container svelte-p61mb1");
    			add_location(div0, file$g, 12, 2, 1251);
    			attr_dev(div1, "class", "text-container svelte-p61mb1");
    			add_location(div1, file$g, 15, 2, 1386);
    			attr_dev(div2, "class", "container svelte-p61mb1");
    			add_location(div2, file$g, 11, 0, 1224);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(t_value);
    			attr_dev(p, "class", "svelte-b4904z");
    			add_location(p, file$e, 62, 8, 4714);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(p, "class", "svelte-b4904z");
    			add_location(p, file$e, 70, 8, 4895);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "heading svelte-b4904z");
    			add_location(h1, file$e, 49, 0, 4175);
    			...
    			attr_dev(img0, "class", "svelte-b4904z");
    			add_location(img0, file$e, 54, 8, 4360);
    			attr_dev(div0, "class", "image-container svelte-b4904z");
    			add_location(div0, file$e, 53, 6, 4321);
    			...
    			attr_dev(img1, "class", "svelte-b4904z");
    			add_location(img1, file$e, 57, 8, 4505);
    			attr_dev(div1, "class", "image-container svelte-b4904z");
    			add_location(div1, file$e, 56, 6, 4466);
    			attr_dev(div2, "class", "image-row svelte-b4904z");
    			add_location(div2, file$e, 52, 4, 4290);
    			attr_dev(div3, "class", "text-container svelte-b4904z");
    			add_location(div3, file$e, 60, 4, 4623);
    			attr_dev(div4, "class", "section svelte-b4904z");
    			add_location(div4, file$e, 51, 2, 4263);
    			attr_dev(div5, "class", "text-container svelte-b4904z");
    			add_location(div5, file$e, 68, 4, 4804);
    			attr_dev(div6, "class", "section svelte-b4904z");
    			add_location(div6, file$e, 67, 2, 4777);
    			attr_dev(div7, "class", "container svelte-b4904z");
    			add_location(div7, file$e, 50, 0, 4236);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			br5 = element("br");
    			t41 = text("\r\n    Bosco MUN 2024");
    			attr_dev(h1, "class", "heading svelte-1igkq9e");
    			add_location(h1, file$c, 5, 0, 100);
    			if (!src_url_equal(img.src, img_src_value = /*imageUrl*/ ctx[0])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Devansh");
    			attr_dev(img, "loading", "lazy");
    			attr_dev(img, "class", "svelte-1igkq9e");
    			add_location(img, file$c, 8, 4, 220);
    			attr_dev(div0, "class", "image-container svelte-1igkq9e");
    			add_location(div0, file$c, 7, 2, 185);
    			attr_dev(strong0, "class", "highlight svelte-1igkq9e");
    			add_location(strong0, file$c, 11, 7, 357);
    			attr_dev(p0, "class", "svelte-1igkq9e");
    			add_location(p0, file$c, 11, 4, 354);
    			attr_dev(strong1, "class", "highlight svelte-1igkq9e");
    			add_location(strong1, file$c, 12, 7, 433);
    			attr_dev(p1, "class", "svelte-1igkq9e");
    			add_location(p1, file$c, 12, 4, 430);
    			attr_dev(strong2, "class", "highlight svelte-1igkq9e");
    			add_location(strong2, file$c, 13, 7, 514);
    			attr_dev(p2, "class", "svelte-1igkq9e");
    			add_location(p2, file$c, 13, 4, 511);
    			attr_dev(strong3, "class", "highlight svelte-1igkq9e");
    			add_location(strong3, file$c, 14, 7, 586);
    			attr_dev(p3, "class", "svelte-1igkq9e");
    			add_location(p3, file$c, 14, 4, 583);
    			add_location(br0, file$c, 15, 4, 661);
    			attr_dev(strong4, "class", "highlight-underline svelte-1igkq9e");
    			add_location(strong4, file$c, 16, 31, 698);
    			attr_dev(p4, "class", "address-section svelte-1igkq9e");
    			add_location(p4, file$c, 16, 4, 671);
    			attr_dev(p5, "class", "svelte-1igkq9e");
    			add_location(p5, file$c, 17, 4, 775);
    			attr_dev(p6, "class", "svelte-1igkq9e");
    			add_location(p6, file$c, 18, 4, 1130);
    			attr_dev(p7, "class", "svelte-1igkq9e");
    			add_location(p7, file$c, 19, 4, 1575);
    			attr_dev(p8, "class", "svelte-1igkq9e");
    			add_location(p8, file$c, 20, 4, 1741);
    			attr_dev(p9, "class", "svelte-1igkq9e");
    			add_location(p9, file$c, 21, 4, 1992);
    			attr_dev(p10, "class", "svelte-1igkq9e");
    			add_location(p10, file$c, 22, 4, 2257);
    			attr_dev(p11, "class", "svelte-1igkq9e");
    			add_location(p11, file$c, 23, 4, 2654);
    			attr_dev(p12, "class", "svelte-1igkq9e");
    			add_location(p12, file$c, 24, 4, 2817);
    			attr_dev(p13, "class", "svelte-1igkq9e");
    			...
    			attr_dev(p14, "class", "svelte-1igkq9e");
    			add_location(p14, file$c, 26, 4, 3896);
    			attr_dev(div1, "class", "text-container svelte-1igkq9e");
    			add_location(div1, file$c, 10, 2, 320);
    			attr_dev(div2, "class", "container svelte-1igkq9e");
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p15, "class", "svelte-1igkq9e");
    			...
    			attr_dev(p16, "class", "svelte-1igkq9e");
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(strong3, "class", "highlight-underline svelte-1igkq9e");
    			add_location(strong3, file$9, 15, 31, 657);
    			attr_dev(p3, "class", "address-section svelte-1igkq9e");
    			add_location(p3, file$9, 15, 4, 630);
    			attr_dev(p4, "class", "svelte-1igkq9e");
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(strong2, "class", "highlight-underline svelte-1igkq9e");
    			add_location(strong2, file$7, 14, 31, 552);
    			attr_dev(p2, "class", "address-section svelte-1igkq9e");
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h10, "class", "gallery-heading svelte-1ivmm3w");
    			add_location(h10, file$6, 28, 0, 783);
    			attr_dev(div0, "class", "gallery svelte-1ivmm3w");
    			add_location(div0, file$6, 29, 0, 830);
    			attr_dev(h11, "class", "gallery-heading svelte-1ivmm3w");
    			add_location(h11, file$6, 37, 0, 1029);
    			attr_dev(div1, "class", "gallery svelte-1ivmm3w");
    			add_location(div1, file$6, 38, 0, 1073);
    			attr_dev(h12, "class", "gallery-heading svelte-1ivmm3w");
    			add_location(h12, file$6, 46, 0, 1276);
    			attr_dev(div2, "class", "gallery svelte-1ivmm3w");
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p1, file$4, 67, 8, 1436);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div8, file$3, 327, 2, 7907);
    			attr_dev(div9, "class", "navbar svelte-1tkslrp");
    			add_location(div9, file$3, 301, 0, 6294);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 22, 0, 954);
    			add_location(style, file, 43, 0, 1829);
    		},
    		m: function mount(target, anchor) {

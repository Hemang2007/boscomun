    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$g, 247, 8, 7196);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment$g(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$g, 225, 4, 6365);
    			attr_dev(div0, "class", "event-title svelte-16v24g0");
    			add_location(div0, file$g, 226, 4, 6419);
    			attr_dev(div1, "class", "logo-container svelte-16v24g0");
    			add_location(div1, file$g, 224, 0, 6331);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h32, file$3, 119, 8, 2744);
    			attr_dev(p9, "class", "svelte-14n03nn");
    			add_location(p9, file$3, 120, 8, 2771);
    			attr_dev(p10, "class", "svelte-14n03nn");
    			add_location(p10, file$3, 121, 8, 2802);
    			attr_dev(p11, "class", "svelte-14n03nn");
    			add_location(p11, file$3, 122, 8, 2835);
    			attr_dev(h23, "class", "svelte-14n03nn");
    			add_location(h23, file$3, 123, 8, 2870);
    			attr_dev(h33, "class", "svelte-14n03nn");
    			add_location(h33, file$3, 125, 8, 2906);
    			attr_dev(p12, "class", "svelte-14n03nn");
    			add_location(p12, file$3, 126, 8, 2964);
    			attr_dev(p13, "class", "svelte-14n03nn");
    			add_location(p13, file$3, 127, 8, 3009);
    			attr_dev(p14, "class", "svelte-14n03nn");
    			add_location(p14, file$3, 128, 8, 3067);
    			attr_dev(p15, "class", "svelte-14n03nn");
    			add_location(p15, file$3, 129, 8, 3116);
    			attr_dev(h34, "class", "svelte-14n03nn");
    			add_location(h34, file$3, 131, 8, 3173);
    			attr_dev(p16, "class", "svelte-14n03nn");
    			add_location(p16, file$3, 132, 8, 3230);
    			attr_dev(p17, "class", "svelte-14n03nn");
    			add_location(p17, file$3, 133, 8, 3273);
    			attr_dev(p18, "class", "svelte-14n03nn");
    			add_location(p18, file$3, 134, 8, 3332);
    			attr_dev(p19, "class", "svelte-14n03nn");
    			add_location(p19, file$3, 135, 8, 3383);
    			attr_dev(h35, "class", "svelte-14n03nn");
    			add_location(h35, file$3, 137, 8, 3434);
    			attr_dev(p20, "class", "svelte-14n03nn");
    			add_location(p20, file$3, 138, 8, 3476);
    			attr_dev(p21, "class", "svelte-14n03nn");
    			add_location(p21, file$3, 139, 8, 3525);
    			attr_dev(p22, "class", "svelte-14n03nn");
    			add_location(p22, file$3, 140, 8, 3586);
    			attr_dev(p23, "class", "svelte-14n03nn");
    			add_location(p23, file$3, 141, 8, 3639);
    			attr_dev(h36, "class", "svelte-14n03nn");
    			add_location(h36, file$3, 143, 8, 3694);
    			attr_dev(p24, "class", "svelte-14n03nn");
    			add_location(p24, file$3, 144, 8, 3758);
    			attr_dev(p25, "class", "svelte-14n03nn");
    			add_location(p25, file$3, 145, 8, 3835);
    			attr_dev(p26, "class", "svelte-14n03nn");
    			add_location(p26, file$3, 146, 8, 3886);
    			attr_dev(h37, "class", "svelte-14n03nn");
    			add_location(h37, file$3, 149, 8, 3943);
    			attr_dev(p27, "class", "svelte-14n03nn");
    			add_location(p27, file$3, 150, 8, 3981);
    			attr_dev(p28, "class", "svelte-14n03nn");
    			add_location(p28, file$3, 151, 8, 4057);
    			attr_dev(p29, "class", "svelte-14n03nn");
    			add_location(p29, file$3, 152, 8, 4118);
    			attr_dev(h38, "class", "svelte-14n03nn");
    			add_location(h38, file$3, 154, 8, 4183);
    			attr_dev(p30, "class", "svelte-14n03nn");
    			add_location(p30, file$3, 155, 8, 4235);
    			attr_dev(p31, "class", "svelte-14n03nn");
    			add_location(p31, file$3, 156, 8, 4294);

...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "end-message svelte-16v24g0");
    			add_location(div, file$g, 240, 8, 6747);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "value svelte-16v24g0");
    			add_location(div0, file$g, 223, 16, 6128);
    			attr_dev(div1, "class", "label svelte-16v24g0");
    			add_location(div1, file$g, 224, 16, 6177);
    			attr_dev(div2, "class", "time-section svelte-16v24g0");
    			add_location(div2, file$g, 222, 12, 6084);
    			attr_dev(div3, "class", "value svelte-16v24g0");
    			add_location(div3, file$g, 227, 16, 6284);
    			attr_dev(div4, "class", "label svelte-16v24g0");
    			add_location(div4, file$g, 228, 16, 6334);
    			attr_dev(div5, "class", "time-section svelte-16v24g0");
    			add_location(div5, file$g, 226, 12, 6240);
    			attr_dev(div6, "class", "value svelte-16v24g0");
    			add_location(div6, file$g, 231, 16, 6442);
    			attr_dev(div7, "class", "label svelte-16v24g0");
    			add_location(div7, file$g, 232, 16, 6494);
    			attr_dev(div8, "class", "time-section svelte-16v24g0");
    			add_location(div8, file$g, 230, 12, 6398);
    			attr_dev(div9, "class", "value svelte-16v24g0");
    			add_location(div9, file$g, 235, 16, 6604);
    			attr_dev(div10, "class", "label svelte-16v24g0");
    			add_location(div10, file$g, 236, 16, 6656);
    			attr_dev(div11, "class", "time-section svelte-16v24g0");
    			add_location(div11, file$g, 234, 12, 6560);
    			attr_dev(div12, "class", "timer svelte-16v24g0");
    			add_location(div12, file$g, 221, 8, 6051);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$g(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "logo svelte-16v24g0");
    			add_location(img, file$g, 218, 4, 5916);
    			attr_dev(div0, "class", "event-title svelte-16v24g0");
    			add_location(div0, file$g, 219, 4, 5970);
    			attr_dev(div1, "class", "logo-container svelte-16v24g0");
    			add_location(div1, file$g, 217, 0, 5882);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$g($$self, $$props, $$invalidate) {
    	...
    	const calculateTimeLeft = () => {
    		...
    		$$invalidate(0, days = days.toString().padStart(2, '0'));
    	...
    	return [days, hours, minutes, seconds, timerEnded];
    }
    ...
    const file$f = "src\\AboutBoscoMUN.svelte";
    ...
    function create_each_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$f, 18, 6, 1903);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$f(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div1, file$f, 16, 2, 1817);
...
`;
    ...
    const file$e = "src\\SecGenMessage.svelte";
...
`;
    ...
    const file$d = "src\\DepSecGenMessage.svelte";
...
`;
    ...
    const file$c = "src\\PrincipalAddress.svelte";
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$c, 19, 8, 1419);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Rev. Fr. Rector and Principal's Address";
    			t1 = space();
    			div2 = element("div");
    			div0 = element("div");
    			img = element("img");
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	let textContent = `The last century, precisely speaking from 1924 to 2024 was a highly transformative period in human history characterized by unprecedented technological, political, social and economic advancements. Just to name a few of the significant broad areas have been Wars and Conflicts, Political Movements, Technological Revolution, Social Progress, Economic Shifts and Medical Advancements. Covering these broad areas of human existence, the students & teachers of DBPC this year are organizing the 9th edition of BOSCO MUN 2024, on 8th and 9th of August.
...
Principal
  `;
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "loading", "lazy");
    			add_location(img0, file$b, 7, 2, 158);
    			attr_dev(h1, "class", "heading svelte-4i2gqz");
    			add_location(h1, file$b, 6, 0, 134);
    			...
    			add_location(img1, file$b, 11, 4, 321);
    			attr_dev(div0, "class", "image-container svelte-4i2gqz");
    			add_location(div0, file$b, 10, 2, 286);
    			attr_dev(strong0, "class", "highlight svelte-4i2gqz");
    			add_location(strong0, file$b, 14, 7, 455);
    			attr_dev(p0, "class", "svelte-4i2gqz");
    			add_location(p0, file$b, 14, 4, 452);
    			attr_dev(strong1, "class", "highlight svelte-4i2gqz");
    			add_location(strong1, file$b, 15, 7, 531);
    			attr_dev(p1, "class", "svelte-4i2gqz");
    			add_location(p1, file$b, 15, 4, 528);
    			attr_dev(strong2, "class", "highlight svelte-4i2gqz");
    			add_location(strong2, file$b, 16, 7, 612);
    			attr_dev(p2, "class", "svelte-4i2gqz");
    			add_location(p2, file$b, 16, 4, 609);
    			attr_dev(strong3, "class", "highlight svelte-4i2gqz");
    			add_location(strong3, file$b, 17, 7, 684);
    			attr_dev(p3, "class", "svelte-4i2gqz");
    			add_location(p3, file$b, 17, 4, 681);
    			add_location(br0, file$b, 18, 4, 759);
    			attr_dev(strong4, "class", "highlight-underline svelte-4i2gqz");
    			add_location(strong4, file$b, 19, 31, 796);
    			attr_dev(p4, "class", "address-section svelte-4i2gqz");
    			add_location(p4, file$b, 19, 4, 769);
    			attr_dev(p5, "class", "svelte-4i2gqz");
    			add_location(p5, file$b, 20, 4, 871);
    			attr_dev(p6, "class", "svelte-4i2gqz");
    			add_location(p6, file$b, 21, 4, 1278);
    			attr_dev(p7, "class", "svelte-4i2gqz");
    			add_location(p7, file$b, 23, 4, 1788);
    			add_location(br1, file$b, 24, 8, 2042);
    			attr_dev(strong5, "class", "highlight svelte-4i2gqz");
    			add_location(strong5, file$b, 25, 7, 2055);
    			attr_dev(p8, "class", "svelte-4i2gqz");
    			add_location(p8, file$b, 25, 4, 2052);
    			add_location(br2, file$b, 26, 4, 2135);
    			attr_dev(strong6, "class", "highlight-underline svelte-4i2gqz");
    			add_location(strong6, file$b, 27, 31, 2172);
    			attr_dev(p9, "class", "address-section svelte-4i2gqz");
    			add_location(p9, file$b, 27, 4, 2145);
    			attr_dev(p10, "class", "svelte-4i2gqz");
    			add_location(p10, file$b, 28, 4, 2249);
    			attr_dev(p11, "class", "svelte-4i2gqz");
    			add_location(p11, file$b, 29, 4, 2604);
    			attr_dev(p12, "class", "svelte-4i2gqz");
    			add_location(p12, file$b, 30, 4, 3049);
    			attr_dev(p13, "class", "svelte-4i2gqz");
    			add_location(p13, file$b, 31, 4, 3215);
    			attr_dev(p14, "class", "svelte-4i2gqz");
    			add_location(p14, file$b, 32, 4, 3466);
    			attr_dev(p15, "class", "svelte-4i2gqz");
    			add_location(p15, file$b, 33, 4, 3731);
    			attr_dev(p16, "class", "svelte-4i2gqz");
    			add_location(p16, file$b, 34, 4, 4128);
    			attr_dev(p17, "class", "svelte-4i2gqz");
    			add_location(p17, file$b, 35, 4, 4291);
    			attr_dev(p18, "class", "svelte-4i2gqz");
    			add_location(p18, file$b, 36, 4, 4942);
    			add_location(br3, file$b, 37, 15, 5379);
    			add_location(br4, file$b, 38, 20, 5405);
    			add_location(br5, file$b, 39, 22, 5433);
    			add_location(br6, file$b, 40, 51, 5490);
    			add_location(br7, file$b, 41, 26, 5522);
    			attr_dev(p19, "class", "svelte-4i2gqz");
    			add_location(p19, file$b, 37, 4, 5368);
    			attr_dev(div1, "class", "text-container svelte-4i2gqz");
    			add_location(div1, file$b, 13, 2, 418);
    			attr_dev(div2, "class", "container svelte-4i2gqz");
    			add_location(div2, file$b, 9, 0, 259);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "logo svelte-4i2gqz");
    			attr_dev(img0, "loading", "lazy");
    			add_location(img0, file$a, 7, 2, 160);
    			attr_dev(h1, "class", "heading svelte-4i2gqz");
    			add_location(h1, file$a, 6, 0, 136);
    			if (!src_url_equal(img1.src, img1_src_value = /*imageUrl*/ ctx[0])) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "AIPPM");
    			attr_dev(img1, "loading", "lazy");
    			attr_dev(img1, "class", "svelte-4i2gqz");
    			add_location(img1, file$a, 11, 4, 324);
    			attr_dev(div0, "class", "image-container svelte-4i2gqz");
    			add_location(div0, file$a, 10, 2, 289);
    			attr_dev(strong0, "class", "highlight svelte-4i2gqz");
    			add_location(strong0, file$a, 14, 7, 459);
    			attr_dev(p0, "class", "svelte-4i2gqz");
    			add_location(p0, file$a, 14, 4, 456);
    			attr_dev(strong1, "class", "highlight svelte-4i2gqz");
    			add_location(strong1, file$a, 15, 7, 532);
    			attr_dev(p1, "class", "svelte-4i2gqz");
    			add_location(p1, file$a, 15, 4, 529);
    			attr_dev(strong2, "class", "highlight svelte-4i2gqz");
    			add_location(strong2, file$a, 16, 7, 614);
    			attr_dev(p2, "class", "svelte-4i2gqz");
    			add_location(p2, file$a, 16, 4, 611);
    			attr_dev(strong3, "class", "highlight svelte-4i2gqz");
    			add_location(strong3, file$a, 17, 7, 687);
    			attr_dev(p3, "class", "svelte-4i2gqz");
    			add_location(p3, file$a, 17, 4, 684);
    			add_location(br0, file$a, 18, 4, 756);
    			attr_dev(strong4, "class", "highlight-underline svelte-4i2gqz");
    			add_location(strong4, file$a, 19, 31, 793);
    			attr_dev(p4, "class", "address-section svelte-4i2gqz");
    			add_location(p4, file$a, 19, 4, 766);
    			attr_dev(p5, "class", "svelte-4i2gqz");
    			add_location(p5, file$a, 20, 4, 868);
    			attr_dev(p6, "class", "svelte-4i2gqz");
    			add_location(p6, file$a, 22, 4, 1304);
    			attr_dev(p7, "class", "svelte-4i2gqz");
    			add_location(p7, file$a, 24, 4, 1552);
    			attr_dev(p8, "class", "svelte-4i2gqz");
    			add_location(p8, file$a, 26, 4, 1780);
    			add_location(br1, file$a, 27, 8, 2118);
    			attr_dev(strong5, "class", "highlight svelte-4i2gqz");
    			add_location(strong5, file$a, 28, 7, 2131);
    			attr_dev(p9, "class", "svelte-4i2gqz");
    			add_location(p9, file$a, 28, 4, 2128);
    			add_location(br2, file$a, 29, 4, 2243);
    			attr_dev(strong6, "class", "highlight-underline svelte-4i2gqz");
    			add_location(strong6, file$a, 30, 31, 2280);
    			attr_dev(p10, "class", "address-section svelte-4i2gqz");
    			add_location(p10, file$a, 30, 4, 2253);
    			attr_dev(p11, "class", "svelte-4i2gqz");
    			add_location(p11, file$a, 31, 4, 2357);
    			attr_dev(p12, "class", "svelte-4i2gqz");
    			add_location(p12, file$a, 32, 6, 2392);
    			attr_dev(p13, "class", "svelte-4i2gqz");
    			add_location(p13, file$a, 33, 4, 2581);
    			attr_dev(p14, "class", "svelte-4i2gqz");
    			add_location(p14, file$a, 34, 4, 3257);
    			attr_dev(p15, "class", "svelte-4i2gqz");
    			add_location(p15, file$a, 35, 4, 3325);
    			attr_dev(p16, "class", "svelte-4i2gqz");
    			add_location(p16, file$a, 36, 4, 3868);
    			attr_dev(p17, "class", "svelte-4i2gqz");
    			add_location(p17, file$a, 38, 4, 4272);
    			attr_dev(p18, "class", "svelte-4i2gqz");
    			add_location(p18, file$a, 40, 4, 4809);
    			attr_dev(p19, "class", "svelte-4i2gqz");
    			add_location(p19, file$a, 42, 4, 5366);
    			attr_dev(p20, "class", "svelte-4i2gqz");
    			add_location(p20, file$a, 43, 4, 5822);
    			attr_dev(p21, "class", "svelte-4i2gqz");
    			add_location(p21, file$a, 45, 4, 6391);
    			add_location(br3, file$a, 45, 25, 6412);
    			add_location(br4, file$a, 46, 15, 6433);
    			add_location(br5, file$a, 47, 16, 6455);
    			add_location(br6, file$a, 48, 29, 6490);
    			add_location(br7, file$a, 49, 50, 6546);
    			add_location(br8, file$a, 50, 26, 6578);
    			attr_dev(p22, "class", "svelte-4i2gqz");
    			add_location(p22, file$a, 46, 4, 6422);
    			attr_dev(div1, "class", "text-container svelte-4i2gqz");
    			add_location(div1, file$a, 13, 2, 422);
    			attr_dev(div2, "class", "container svelte-4i2gqz");
    			add_location(div2, file$a, 9, 0, 262);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "logo svelte-4i2gqz");
    			attr_dev(img0, "loading", "lazy");
    			add_location(img0, file$9, 7, 2, 156);
    			attr_dev(h1, "class", "heading svelte-4i2gqz");
    			add_location(h1, file$9, 6, 0, 132);
    			if (!src_url_equal(img1.src, img1_src_value = /*imageUrl*/ ctx[0])) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "JSC");
    			attr_dev(img1, "loading", "lazy");
    			attr_dev(img1, "class", "svelte-4i2gqz");
    			add_location(img1, file$9, 11, 4, 311);
    			attr_dev(div0, "class", "image-container svelte-4i2gqz");
    			add_location(div0, file$9, 10, 2, 276);
    			attr_dev(strong0, "class", "highlight svelte-4i2gqz");
    			add_location(strong0, file$9, 14, 7, 444);
    			attr_dev(p0, "class", "svelte-4i2gqz");
    			add_location(p0, file$9, 14, 4, 441);
    			attr_dev(strong1, "class", "highlight svelte-4i2gqz");
    			add_location(strong1, file$9, 15, 7, 527);
    			attr_dev(p1, "class", "svelte-4i2gqz");
    			add_location(p1, file$9, 15, 4, 524);
    			attr_dev(strong2, "class", "highlight svelte-4i2gqz");
    			add_location(strong2, file$9, 16, 7, 615);
    			attr_dev(p2, "class", "svelte-4i2gqz");
    			add_location(p2, file$9, 16, 4, 612);
    			attr_dev(strong3, "class", "highlight svelte-4i2gqz");
    			add_location(strong3, file$9, 17, 7, 694);
    			attr_dev(p3, "class", "svelte-4i2gqz");
    			add_location(p3, file$9, 17, 4, 691);
    			add_location(br0, file$9, 18, 4, 771);
    			attr_dev(strong4, "class", "highlight-underline svelte-4i2gqz");
    			add_location(strong4, file$9, 19, 31, 808);
    			attr_dev(p4, "class", "address-section svelte-4i2gqz");
    			add_location(p4, file$9, 19, 4, 781);
    			attr_dev(p5, "class", "svelte-4i2gqz");
    			add_location(p5, file$9, 20, 4, 883);
    			attr_dev(p6, "class", "svelte-4i2gqz");
    			add_location(p6, file$9, 22, 4, 1202);
    			attr_dev(p7, "class", "svelte-4i2gqz");
    			add_location(p7, file$9, 24, 4, 1438);
    			add_location(br1, file$9, 25, 8, 2015);
    			attr_dev(strong5, "class", "highlight svelte-4i2gqz");
    			add_location(strong5, file$9, 26, 7, 2028);
    			attr_dev(p8, "class", "svelte-4i2gqz");
    			add_location(p8, file$9, 26, 4, 2025);
    			add_location(br2, file$9, 27, 4, 2102);
    			attr_dev(strong6, "class", "highlight-underline svelte-4i2gqz");
    			add_location(strong6, file$9, 28, 31, 2139);
    			attr_dev(p9, "class", "address-section svelte-4i2gqz");
    			add_location(p9, file$9, 28, 4, 2112);
    			attr_dev(p10, "class", "svelte-4i2gqz");
    			add_location(p10, file$9, 29, 4, 2216);
    			attr_dev(p11, "class", "svelte-4i2gqz");
    			add_location(p11, file$9, 31, 4, 2255);
    			attr_dev(p12, "class", "svelte-4i2gqz");
    			add_location(p12, file$9, 33, 4, 2563);
    			attr_dev(p13, "class", "svelte-4i2gqz");
    			add_location(p13, file$9, 35, 4, 2756);
    			attr_dev(p14, "class", "svelte-4i2gqz");
    			add_location(p14, file$9, 37, 4, 3141);
    			attr_dev(p15, "class", "svelte-4i2gqz");
    			add_location(p15, file$9, 39, 4, 3513);
    			attr_dev(p16, "class", "svelte-4i2gqz");
    			add_location(p16, file$9, 41, 4, 3753);
    			attr_dev(p17, "class", "svelte-4i2gqz");
    			add_location(p17, file$9, 42, 4, 4120);
    			add_location(br3, file$9, 43, 15, 4336);
    			add_location(br4, file$9, 44, 25, 4367);
    			add_location(br5, file$9, 45, 29, 4402);
    			add_location(br6, file$9, 46, 41, 4449);
    			add_location(br7, file$9, 47, 26, 4481);
    			attr_dev(p18, "class", "svelte-4i2gqz");
    			add_location(p18, file$9, 43, 4, 4325);
    			attr_dev(div1, "class", "text-container svelte-4i2gqz");
    			add_location(div1, file$9, 13, 2, 407);
    			attr_dev(div2, "class", "container svelte-4i2gqz");
    			add_location(div2, file$9, 9, 0, 249);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "loading", "lazy");
    			add_location(img0, file$8, 7, 2, 160);
    			attr_dev(h1, "class", "heading svelte-145zfp3");
    			add_location(h1, file$8, 6, 0, 136);
    			if (!src_url_equal(img1.src, img1_src_value = /*imageUrl*/ ctx[0])) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "ASEAN");
    			attr_dev(img1, "loading", "lazy");
    			attr_dev(img1, "class", "svelte-145zfp3");
    			add_location(img1, file$8, 11, 4, 330);
    			attr_dev(div0, "class", "image-container svelte-145zfp3");
    			add_location(div0, file$8, 10, 2, 295);
    			attr_dev(strong0, "class", "highlight svelte-145zfp3");
    			add_location(strong0, file$8, 14, 7, 465);
    			attr_dev(p0, "class", "svelte-145zfp3");
    			add_location(p0, file$8, 14, 4, 462);
    			attr_dev(strong1, "class", "highlight svelte-145zfp3");
    			add_location(strong1, file$8, 15, 7, 562);
    			attr_dev(p1, "class", "svelte-145zfp3");
    			add_location(p1, file$8, 15, 4, 559);
    			attr_dev(strong2, "class", "highlight svelte-145zfp3");
    			add_location(strong2, file$8, 16, 7, 644);
    			attr_dev(p2, "class", "svelte-145zfp3");
    			add_location(p2, file$8, 16, 4, 641);
    			add_location(br0, file$8, 17, 4, 721);
    			attr_dev(strong3, "class", "highlight-underline svelte-145zfp3");
    			add_location(strong3, file$8, 18, 31, 758);
    			attr_dev(p3, "class", "address-section svelte-145zfp3");
    			add_location(p3, file$8, 18, 4, 731);
    			attr_dev(p4, "class", "svelte-145zfp3");
    			add_location(p4, file$8, 19, 4, 833);
    			attr_dev(p5, "class", "svelte-145zfp3");
    			add_location(p5, file$8, 21, 4, 1265);
    			attr_dev(p6, "class", "svelte-145zfp3");
    			add_location(p6, file$8, 23, 4, 1523);
    			add_location(br1, file$8, 24, 8, 2100);
    			attr_dev(strong4, "class", "highlight svelte-145zfp3");
    			add_location(strong4, file$8, 25, 7, 2113);
    			attr_dev(p7, "class", "svelte-145zfp3");
    			add_location(p7, file$8, 25, 4, 2110);
    			add_location(br2, file$8, 26, 4, 2193);
    			attr_dev(strong5, "class", "highlight-underline svelte-145zfp3");
    			add_location(strong5, file$8, 27, 31, 2230);
    			attr_dev(p8, "class", "address-section svelte-145zfp3");
    			add_location(p8, file$8, 27, 4, 2203);
    			attr_dev(p9, "class", "svelte-145zfp3");
    			add_location(p9, file$8, 28, 4, 2307);
    			attr_dev(p10, "class", "svelte-145zfp3");
    			add_location(p10, file$8, 30, 4, 2346);
    			attr_dev(p11, "class", "svelte-145zfp3");
    			add_location(p11, file$8, 32, 4, 2586);
    			attr_dev(p12, "class", "svelte-145zfp3");
    			add_location(p12, file$8, 33, 4, 2663);
    			attr_dev(p13, "class", "svelte-145zfp3");
    			add_location(p13, file$8, 35, 4, 3437);
    			attr_dev(p14, "class", "svelte-145zfp3");
    			add_location(p14, file$8, 37, 4, 3789);
    			add_location(br3, file$8, 39, 15, 4927);
    			add_location(br4, file$8, 40, 40, 4973);
    			add_location(br5, file$8, 41, 67, 5046);
    			add_location(br6, file$8, 42, 26, 5078);
    			attr_dev(p15, "class", "svelte-145zfp3");
    			add_location(p15, file$8, 39, 4, 4916);
    			attr_dev(div1, "class", "text-container svelte-145zfp3");
    			add_location(div1, file$8, 13, 2, 428);
    			attr_dev(div2, "class", "container svelte-145zfp3");
    			add_location(div2, file$8, 9, 0, 268);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img1, "loading", "lazy");
    			attr_dev(img1, "class", "svelte-4i2gqz");
    			add_location(img1, file$7, 11, 4, 299);
    			attr_dev(div0, "class", "image-container svelte-4i2gqz");
    			add_location(div0, file$7, 10, 2, 264);
    			attr_dev(strong0, "class", "highlight svelte-4i2gqz");
    			add_location(strong0, file$7, 15, 7, 442);
    			attr_dev(p0, "class", "svelte-4i2gqz");
    			add_location(p0, file$7, 15, 4, 439);
    			attr_dev(strong1, "class", "highlight svelte-4i2gqz");
    			add_location(strong1, file$7, 16, 7, 542);
    			attr_dev(p1, "class", "svelte-4i2gqz");
    			add_location(p1, file$7, 16, 4, 539);
    			attr_dev(strong2, "class", "highlight svelte-4i2gqz");
    			add_location(strong2, file$7, 17, 7, 627);
    			attr_dev(p2, "class", "svelte-4i2gqz");
    			add_location(p2, file$7, 17, 4, 624);
    			add_location(br0, file$7, 18, 4, 710);
    			attr_dev(strong3, "class", "highlight-underline svelte-4i2gqz");
    			add_location(strong3, file$7, 19, 31, 747);
    			attr_dev(p3, "class", "address-section svelte-4i2gqz");
    			add_location(p3, file$7, 19, 4, 720);
    			attr_dev(p4, "class", "svelte-4i2gqz");
    			add_location(p4, file$7, 20, 4, 822);
    			attr_dev(p5, "class", "svelte-4i2gqz");
    			add_location(p5, file$7, 22, 4, 1223);
    			attr_dev(p6, "class", "svelte-4i2gqz");
    			add_location(p6, file$7, 24, 4, 1692);
    			add_location(br1, file$7, 25, 8, 1962);
    			attr_dev(strong4, "class", "highlight svelte-4i2gqz");
    			add_location(strong4, file$7, 26, 7, 1975);
    			attr_dev(p7, "class", "svelte-4i2gqz");
    			add_location(p7, file$7, 26, 4, 1972);
    			add_location(br2, file$7, 27, 4, 2054);
    			attr_dev(strong5, "class", "highlight-underline svelte-4i2gqz");
    			add_location(strong5, file$7, 28, 31, 2091);
    			attr_dev(p8, "class", "address-section svelte-4i2gqz");
    			add_location(p8, file$7, 28, 4, 2064);
    			attr_dev(p9, "class", "svelte-4i2gqz");
    			add_location(p9, file$7, 29, 4, 2168);
    			attr_dev(p10, "class", "svelte-4i2gqz");
    			add_location(p10, file$7, 30, 4, 2205);
    			attr_dev(p11, "class", "svelte-4i2gqz");
    			add_location(p11, file$7, 32, 4, 3174);
    			attr_dev(p12, "class", "svelte-4i2gqz");
    			add_location(p12, file$7, 34, 4, 3258);
    			attr_dev(p13, "class", "svelte-4i2gqz");
    			add_location(p13, file$7, 36, 4, 4015);
    			attr_dev(p14, "class", "svelte-4i2gqz");
    			add_location(p14, file$7, 38, 4, 4664);
    			attr_dev(p15, "class", "svelte-4i2gqz");
    			add_location(p15, file$7, 40, 4, 5159);
    			add_location(br3, file$7, 42, 15, 5629);
    			add_location(br4, file$7, 43, 37, 5672);
    			add_location(br5, file$7, 44, 39, 5717);
    			add_location(br6, file$7, 45, 26, 5749);
    			attr_dev(p16, "class", "svelte-4i2gqz");
    			add_location(p16, file$7, 42, 4, 5618);
    			attr_dev(div1, "class", "text-container svelte-4i2gqz");
    			add_location(div1, file$7, 13, 2, 403);
    			attr_dev(div2, "class", "container svelte-4i2gqz");
    			add_location(div2, file$7, 9, 0, 237);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "logo svelte-4i2gqz");
    			attr_dev(img0, "loading", "lazy");
    			add_location(img0, file$6, 7, 2, 156);
    			attr_dev(h1, "class", "heading svelte-4i2gqz");
    			add_location(h1, file$6, 6, 0, 132);
    			if (!src_url_equal(img1.src, img1_src_value = /*imageUrl*/ ctx[0])) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "IPC");
    			attr_dev(img1, "loading", "lazy");
    			attr_dev(img1, "class", "svelte-4i2gqz");
    			add_location(img1, file$6, 11, 4, 313);
    			attr_dev(div0, "class", "image-container svelte-4i2gqz");
    			add_location(div0, file$6, 10, 2, 278);
    			attr_dev(strong0, "class", "highlight svelte-4i2gqz");
    			add_location(strong0, file$6, 14, 7, 446);
    			attr_dev(p0, "class", "svelte-4i2gqz");
    			add_location(p0, file$6, 14, 4, 443);
    			attr_dev(strong1, "class", "highlight svelte-4i2gqz");
    			add_location(strong1, file$6, 15, 7, 532);
    			attr_dev(p1, "class", "svelte-4i2gqz");
    			add_location(p1, file$6, 15, 4, 529);
    			add_location(br0, file$6, 16, 4, 612);
    			attr_dev(strong2, "class", "highlight-underline svelte-4i2gqz");
    			add_location(strong2, file$6, 17, 31, 649);
    			attr_dev(p2, "class", "address-section svelte-4i2gqz");
    			add_location(p2, file$6, 17, 4, 622);
    			attr_dev(p3, "class", "svelte-4i2gqz");
    			add_location(p3, file$6, 18, 4, 724);
    			attr_dev(p4, "class", "svelte-4i2gqz");
    			add_location(p4, file$6, 20, 4, 1129);
    			attr_dev(p5, "class", "svelte-4i2gqz");
    			add_location(p5, file$6, 22, 4, 1584);
    			add_location(br1, file$6, 23, 8, 1777);
    			attr_dev(strong3, "class", "highlight svelte-4i2gqz");
    			add_location(strong3, file$6, 24, 7, 1790);
    			attr_dev(p6, "class", "svelte-4i2gqz");
    			add_location(p6, file$6, 24, 4, 1787);
    			add_location(br2, file$6, 25, 4, 1962);
    			attr_dev(strong4, "class", "highlight-underline svelte-4i2gqz");
    			add_location(strong4, file$6, 26, 31, 1999);
    			attr_dev(p7, "class", "address-section svelte-4i2gqz");
    			add_location(p7, file$6, 26, 4, 1972);
    			attr_dev(p8, "class", "svelte-4i2gqz");
    			add_location(p8, file$6, 27, 4, 2075);
    			attr_dev(p9, "class", "svelte-4i2gqz");
    			add_location(p9, file$6, 28, 4, 2112);
    			attr_dev(p10, "class", "svelte-4i2gqz");
    			add_location(p10, file$6, 29, 4, 2399);
    			attr_dev(p11, "class", "svelte-4i2gqz");
    			add_location(p11, file$6, 30, 4, 2803);
    			attr_dev(p12, "class", "svelte-4i2gqz");
    			add_location(p12, file$6, 32, 4, 3160);
    			attr_dev(p13, "class", "svelte-4i2gqz");
    			add_location(p13, file$6, 34, 4, 3533);
    			add_location(br3, file$6, 36, 17, 4629);
    			add_location(br4, file$6, 37, 14, 4649);
    			add_location(br5, file$6, 38, 29, 4684);
    			add_location(br6, file$6, 39, 50, 4740);
    			add_location(br7, file$6, 40, 26, 4772);
    			attr_dev(p14, "class", "svelte-4i2gqz");
    			add_location(p14, file$6, 36, 4, 4616);
    			attr_dev(div1, "class", "text-container svelte-4i2gqz");
    			add_location(div1, file$6, 13, 2, 409);
    			attr_dev(div2, "class", "container svelte-4i2gqz");
    			add_location(div2, file$6, 9, 0, 251);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$5 = "src\\Resources.svelte";
    ...
    function create_each_block_2(ctx) {
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[3](/*item*/ ctx[13]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			img = element("img");
    			t = space();
    			if (!src_url_equal(img.src, img_src_value = /*item*/ ctx[13].img)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Study Guides");
    			attr_dev(img, "class", "svelte-1pfgckf");
    			add_location(img, file$5, 37, 6, 1115);
    			attr_dev(div, "class", "item svelte-1pfgckf");
    			add_location(div, file$5, 36, 4, 1050);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(36:2) {#each items as item}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	function click_handler_1() {
    		return /*click_handler_1*/ ctx[4](/*item3*/ ctx[10]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			img = element("img");
    			t = space();
    			if (!src_url_equal(img.src, img_src_value = /*item3*/ ctx[10].img)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Portfolios");
    			attr_dev(img, "class", "svelte-1pfgckf");
    			add_location(img, file$5, 46, 6, 1362);
    			attr_dev(div, "class", "item svelte-1pfgckf");
    			add_location(div, file$5, 45, 4, 1296);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(45:2) {#each items3 as item3}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	function click_handler_2() {
    		return /*click_handler_2*/ ctx[5](/*item2*/ ctx[7]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			img = element("img");
    			t = space();
    			if (!src_url_equal(img.src, img_src_value = /*item2*/ ctx[7].img)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Resources");
    			attr_dev(img, "class", "svelte-1pfgckf");
    			add_location(img, file$5, 55, 6, 1601);
    			attr_dev(div, "class", "item svelte-1pfgckf");
    			add_location(div, file$5, 54, 4, 1535);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(54:2) {#each items2 as item2}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			h11 = element("h1");
    			h11.textContent = "Portfolio Guides";
    			t4 = space();
    			div1 = element("div");
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	let items2 = [
    		...
    		{
    			img: '/schedule.png',
    			pdf: '/pdfs/BoscoMUN24_Conference_Schedule_and_Venues.pdf'
    		}
    	];
    	...
    	const click_handler_1 = item3 => downloadPDF(item3.pdf);
    	const click_handler_2 = item2 => downloadPDF(item2.pdf);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('items4' in $$props) items4 = $$props.items4;
    	};
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(iframe, file$4, 161, 12, 3419);
    			attr_dev(div5, "class", "gmap_canvas svelte-n268od");
    			add_location(div5, file$4, 160, 10, 3380);
    			attr_dev(div6, "class", "mapouter svelte-n268od");
    			add_location(div6, file$4, 159, 8, 3346);
    			attr_dev(div7, "class", "col svelte-n268od");
    			add_location(div7, file$4, 157, 6, 3266);
    			attr_dev(div8, "class", "row svelte-n268od");
    			add_location(div8, file$4, 128, 4, 2069);
    			attr_dev(div9, "class", "container svelte-n268od");
    			add_location(div9, file$4, 127, 2, 2040);
    			attr_dev(div10, "class", "footer svelte-n268od");
    			add_location(div10, file$4, 126, 0, 2016);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "src\\OurTeam.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t15 = space();
    			h22 = element("h2");
    			h22.textContent = "CHARGE D'AFFAIRES";
    			t17 = space();
    			p5 = element("p");
    			p5.textContent = "Aditya Banerjee";
    			t19 = space();
    			h23 = element("h2");
    			h23.textContent = "TECH TEAM";
    			t21 = space();
    			h30 = element("h3");
    			h30.textContent = "VIDEO EDITING";
    			t23 = space();
    			p6 = element("p");
    			p6.textContent = "Pavvit Singh Batra";
    			t25 = space();
    			div0 = element("div");
    			h31 = element("h3");
    			...
    			t27 = space();
    			p7 = element("p");
    			p7.textContent = "Hemang Domadia";
    			t29 = space();
    			p8 = element("p");
    			p8.textContent = "Soham Chowdhury";
    			t31 = space();
    			p9 = element("p");
    			p9.textContent = "Sumedh Gadia";
    			t33 = space();
    			p10 = element("p");
    			p10.textContent = "Inesh Jain";
    			t35 = space();
    			h32 = element("h3");
    			h32.textContent = "GRAPHICS";
    			t37 = space();
    			p11 = element("p");
    			p11.textContent = "Ritesh Agarwal";
    			t39 = space();
    			p12 = element("p");
    			p12.textContent = "Archit Tibrewala";
    			t41 = space();
    			p13 = element("p");
    			p13.textContent = "Abhiraj Chatterjee";
    			t43 = space();
    			h33 = element("h3");
    			h33.textContent = "SPECIAL MENTIONS";
    			t45 = space();
    			p14 = element("p");
    			p14.textContent = "Abhay Poddar";
    			t47 = space();
    			h24 = element("h2");
    			h24.textContent = "EXECUTIVE BOARD";
    			t49 = space();
    			h34 = element("h3");
    			h34.textContent = "UNITED NATIONS SECURITY COUNCIL";
    			t51 = space();
    			p15 = element("p");
    			p15.textContent = "Chairperson: Devansh Agarwal";
    			t53 = space();
    			p16 = element("p");
    			p16.textContent = "Vice Chairperson: Aryaman Saraogi";
    			t55 = space();
    			p17 = element("p");
    			p17.textContent = "Director: Shubham Sethia";
    			t57 = space();
    			p18 = element("p");
    			p18.textContent = "Rapporteur: Harshvardhan Saraf";
    			t59 = space();
    			h35 = element("h3");
    			h35.textContent = "ALL INDIA POLITICAL PARTY MEET";
    			t61 = space();
    			p19 = element("p");
    			p19.textContent = "Chairpersons: Amay Rathore";
    			t63 = space();
    			p20 = element("p");
    			p20.textContent = "Vice Chairperson: Pranjal Tripathi";
    			t65 = space();
    			p21 = element("p");
    			p21.textContent = "Director:  Shaurya Khaitan";
    			t67 = space();
    			p22 = element("p");
    			p22.textContent = "Rapporteur: Shreyas Garg";
    			t69 = space();
    			h36 = element("h3");
    			h36.textContent = "JOSEPH STALIN’S CABINET";
    			t71 = space();
    			p23 = element("p");
    			p23.textContent = "Chairpersons: Rohaan Chakraborty";
    			t73 = space();
    			p24 = element("p");
    			p24.textContent = "Vice Chairperson: Abhiraj Chatterjee";
    			t75 = space();
    			p25 = element("p");
    			p25.textContent = "Director:  Dhrishit Dasgupta";
    			t77 = space();
    			p26 = element("p");
    			p26.textContent = "Rapporteur: Aryaveer Agarwal";
    			t79 = space();
    			h37 = element("h3");
    			h37.textContent = "ASSOCIATION OF SOUTHEAST ASIAN NATIONS";
    			t81 = space();
    			p27 = element("p");
    			p27.textContent = "Co - Chairpersons: Pavvit Singh Batra & Om Arya Paul";
    			t83 = space();
    			p28 = element("p");
    			p28.textContent = "Vice Chairperson: Shreyansh Surana";
    			t85 = space();
    			p29 = element("p");
    			p29.textContent = "Rapporteur: Rajveer Kumar Pruthi";
    			t87 = space();
    			h38 = element("h3");
    			h38.textContent = "ARAB LEAGUE";
    			t89 = space();
    			p30 = element("p");
    			p30.textContent = "Co - Chairpersons: Yuvraj Berlia and Devansh Sharma";
    			t91 = space();
    			p31 = element("p");
    			p31.textContent = "Vice Chairperson: Siddhant Khinwasara";
    			t93 = space();
    			p32 = element("p");
    			p32.textContent = "Rapporteur: Ayush Abhinandan Choudhury";
    			t95 = space();
    			h39 = element("h3");
    			h39.textContent = "INTERNATIONAL PRESS CORPS";
    			t97 = space();
    			p33 = element("p");
    			p33.textContent = "Press Head: Riddhiman Gangopadhyay";
    			t99 = space();
    			p34 = element("p");
    			p34.textContent = "Deputy Press Head: Himank More";
    			t101 = space();
    			create_component(footer.$$.fragment);
    			attr_dev(h1, "class", "svelte-14n03nn");
    			add_location(h1, file$3, 101, 8, 2093);
    			attr_dev(h20, "class", "svelte-14n03nn");
    			add_location(h20, file$3, 102, 8, 2120);
    			attr_dev(p0, "class", "svelte-14n03nn");
    			add_location(p0, file$3, 103, 8, 2147);
    			attr_dev(p1, "class", "svelte-14n03nn");
    			add_location(p1, file$3, 104, 8, 2189);
    			attr_dev(h21, "class", "svelte-14n03nn");
    			add_location(h21, file$3, 105, 8, 2221);
    			attr_dev(p2, "class", "svelte-14n03nn");
    			add_location(p2, file$3, 106, 8, 2255);
    			attr_dev(p3, "class", "svelte-14n03nn");
    			add_location(p3, file$3, 107, 8, 2324);
    			attr_dev(p4, "class", "svelte-14n03nn");
    			add_location(p4, file$3, 108, 8, 2402);
    			attr_dev(h22, "class", "svelte-14n03nn");
    			add_location(h22, file$3, 109, 8, 2486);
    			attr_dev(p5, "class", "svelte-14n03nn");
    			add_location(p5, file$3, 110, 8, 2522);
    			attr_dev(h23, "class", "svelte-14n03nn");
    			add_location(h23, file$3, 112, 8, 2556);
    			attr_dev(h30, "class", "svelte-14n03nn");
    			add_location(h30, file$3, 113, 8, 2584);
    			attr_dev(p6, "class", "svelte-14n03nn");
    			add_location(p6, file$3, 114, 8, 2616);
    			attr_dev(h31, "class", "svelte-14n03nn");
    			add_location(h31, file$3, 116, 8, 2682);
    			attr_dev(p7, "class", "svelte-14n03nn");
    			add_location(p7, file$3, 117, 8, 2708);
    			attr_dev(p8, "class", "svelte-14n03nn");
    			add_location(p8, file$3, 118, 8, 2739);
    			attr_dev(p9, "class", "svelte-14n03nn");
    			add_location(p9, file$3, 119, 8, 2771);
    			attr_dev(p10, "class", "svelte-14n03nn");
    			add_location(p10, file$3, 120, 8, 2800);
    			attr_dev(div0, "class", "website svelte-14n03nn");
    			add_location(div0, file$3, 115, 8, 2651);
    			attr_dev(h32, "class", "svelte-14n03nn");
    			add_location(h32, file$3, 122, 8, 2839);
    			attr_dev(p11, "class", "svelte-14n03nn");
    			add_location(p11, file$3, 123, 8, 2866);
    			attr_dev(p12, "class", "svelte-14n03nn");
    			add_location(p12, file$3, 124, 8, 2897);
    			attr_dev(p13, "class", "svelte-14n03nn");
    			add_location(p13, file$3, 125, 8, 2930);
    			attr_dev(h33, "class", "svelte-14n03nn");
    			add_location(h33, file$3, 126, 8, 2965);
    			attr_dev(p14, "class", "svelte-14n03nn");
    			add_location(p14, file$3, 127, 8, 3000);
    			attr_dev(h24, "class", "svelte-14n03nn");
    			add_location(h24, file$3, 128, 8, 3029);
    			attr_dev(h34, "class", "svelte-14n03nn");
    			add_location(h34, file$3, 129, 8, 3063);
    			attr_dev(p15, "class", "svelte-14n03nn");
    			add_location(p15, file$3, 130, 8, 3121);
    			attr_dev(p16, "class", "svelte-14n03nn");
    			add_location(p16, file$3, 131, 8, 3166);
    			attr_dev(p17, "class", "svelte-14n03nn");
    			add_location(p17, file$3, 132, 8, 3224);
    			attr_dev(p18, "class", "svelte-14n03nn");
    			add_location(p18, file$3, 133, 8, 3273);
    			attr_dev(h35, "class", "svelte-14n03nn");
    			add_location(h35, file$3, 135, 8, 3330);
    			attr_dev(p19, "class", "svelte-14n03nn");
    			add_location(p19, file$3, 136, 8, 3387);
    			attr_dev(p20, "class", "svelte-14n03nn");
    			add_location(p20, file$3, 137, 8, 3430);
    			attr_dev(p21, "class", "svelte-14n03nn");
    			add_location(p21, file$3, 138, 8, 3489);
    			attr_dev(p22, "class", "svelte-14n03nn");
    			add_location(p22, file$3, 139, 8, 3540);
    			attr_dev(h36, "class", "svelte-14n03nn");
    			add_location(h36, file$3, 141, 8, 3591);
    			attr_dev(p23, "class", "svelte-14n03nn");
    			add_location(p23, file$3, 142, 8, 3633);
    			attr_dev(p24, "class", "svelte-14n03nn");
    			add_location(p24, file$3, 143, 8, 3682);
    			attr_dev(p25, "class", "svelte-14n03nn");
    			add_location(p25, file$3, 144, 8, 3743);
    			attr_dev(p26, "class", "svelte-14n03nn");
    			add_location(p26, file$3, 145, 8, 3796);
    			attr_dev(h37, "class", "svelte-14n03nn");
    			add_location(h37, file$3, 147, 8, 3851);
    			attr_dev(p27, "class", "svelte-14n03nn");
    			add_location(p27, file$3, 148, 8, 3915);
    			attr_dev(p28, "class", "svelte-14n03nn");
    			add_location(p28, file$3, 149, 8, 3992);
    			attr_dev(p29, "class", "svelte-14n03nn");
    			add_location(p29, file$3, 150, 8, 4043);
    			attr_dev(h38, "class", "svelte-14n03nn");
    			add_location(h38, file$3, 153, 8, 4100);
    			attr_dev(p30, "class", "svelte-14n03nn");
    			add_location(p30, file$3, 154, 8, 4138);
    			attr_dev(p31, "class", "svelte-14n03nn");
    			add_location(p31, file$3, 155, 8, 4214);
    			attr_dev(p32, "class", "svelte-14n03nn");
    			add_location(p32, file$3, 156, 8, 4275);
    			attr_dev(h39, "class", "svelte-14n03nn");
    			add_location(h39, file$3, 158, 8, 4340);
    			attr_dev(p33, "class", "svelte-14n03nn");
    			add_location(p33, file$3, 159, 8, 4392);
    			attr_dev(p34, "class", "svelte-14n03nn");
    			add_location(p34, file$3, 160, 8, 4451);
    			attr_dev(div1, "class", "contact-details svelte-14n03nn");
    			add_location(div1, file$3, 100, 4, 2054);
    			attr_dev(div2, "class", "contact-us-container svelte-14n03nn");
    			add_location(div2, file$3, 99, 0, 2014);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			a3 = element("a");
    			a3.textContent = "Rev. Fr. Rector and Principal's Address";
    			t7 = space();
    			a4 = element("a");
    			...
    			div7 = element("div");
    			attr_dev(a0, "href", "/");
    			attr_dev(a0, "class", "svelte-yp7wdo");
    			add_location(a0, file$2, 307, 4, 6418);
    			attr_dev(a1, "href", "#about");
    			attr_dev(a1, "class", "dropbtn svelte-yp7wdo");
    			add_location(a1, file$2, 309, 6, 6497);
    			attr_dev(a2, "href", "/AboutBoscoMUN");
    			attr_dev(a2, "class", "svelte-yp7wdo");
    			add_location(a2, file$2, 311, 8, 6646);
    			attr_dev(a3, "href", "/PrincipalAddress");
    			attr_dev(a3, "class", "svelte-yp7wdo");
    			add_location(a3, file$2, 312, 8, 6722);
    			attr_dev(a4, "href", "/SecGenMessage");
    			attr_dev(a4, "class", "svelte-yp7wdo");
    			add_location(a4, file$2, 313, 8, 6826);
    			attr_dev(a5, "href", "/DepSecGenMessage");
    			attr_dev(a5, "class", "svelte-yp7wdo");
    			add_location(a5, file$2, 314, 8, 6915);
    			attr_dev(div0, "class", div0_class_value = "dropdown-content " + (/*dropdowns*/ ctx[1]['#about'] ? 'show' : '') + " svelte-yp7wdo");
    			add_location(div0, file$2, 310, 6, 6570);
    			attr_dev(div1, "class", "dropdown svelte-yp7wdo");
    			add_location(div1, file$2, 308, 4, 6467);
    			attr_dev(a6, "href", "#committees");
    			attr_dev(a6, "class", "dropbtn svelte-yp7wdo");
    			add_location(a6, file$2, 318, 6, 7066);
    			attr_dev(a7, "href", "/UNSC");
    			attr_dev(a7, "class", "svelte-yp7wdo");
    			add_location(a7, file$2, 320, 8, 7230);
    			attr_dev(a8, "href", "/AIPPM");
    			attr_dev(a8, "class", "svelte-yp7wdo");
    			add_location(a8, file$2, 321, 8, 7314);
    			attr_dev(a9, "href", "/JSC");
    			attr_dev(a9, "class", "svelte-yp7wdo");
    			add_location(a9, file$2, 322, 8, 7400);
    			attr_dev(a10, "href", "/ASEAN");
    			attr_dev(a10, "class", "svelte-yp7wdo");
    			add_location(a10, file$2, 323, 8, 7475);
    			attr_dev(a11, "href", "/AL");
    			attr_dev(a11, "class", "svelte-yp7wdo");
    			add_location(a11, file$2, 324, 8, 7567);
    			attr_dev(a12, "href", "/IPC");
    			attr_dev(a12, "class", "svelte-yp7wdo");
    			add_location(a12, file$2, 325, 8, 7629);
    			attr_dev(div2, "class", div2_class_value = "dropdown-content " + (/*dropdowns*/ ctx[1]['#committees'] ? 'show' : '') + " svelte-yp7wdo");
    			add_location(div2, file$2, 319, 6, 7149);
    			attr_dev(div3, "class", "dropdown svelte-yp7wdo");
    			add_location(div3, file$2, 317, 4, 7036);
    			attr_dev(a13, "href", "/Resources");
    			attr_dev(a13, "class", "svelte-yp7wdo");
    			add_location(a13, file$2, 328, 4, 7728);
    			attr_dev(a14, "href", "/OurTeam");
    			attr_dev(a14, "class", "svelte-yp7wdo");
    			add_location(a14, file$2, 330, 4, 7911);
    			attr_dev(div4, "class", div4_class_value = "menu-items " + (/*showMenu*/ ctx[0] ? 'show' : '') + " svelte-yp7wdo");
    			add_location(div4, file$2, 306, 2, 6363);
    			attr_dev(div5, "class", "svelte-yp7wdo");
    			add_location(div5, file$2, 340, 4, 8172);
    			attr_dev(div6, "class", "svelte-yp7wdo");
    			add_location(div6, file$2, 341, 4, 8189);
    			attr_dev(div7, "class", "svelte-yp7wdo");
    			add_location(div7, file$2, 342, 4, 8206);
    			attr_dev(div8, "class", div8_class_value = "burger-menu " + (/*showMenu*/ ctx[0] ? 'active' : '') + " svelte-yp7wdo");
    			attr_dev(div8, "tabindex", "0");
    			attr_dev(div8, "role", "button");
    			attr_dev(div8, "aria-label", "Toggle menu");
    			add_location(div8, file$2, 332, 2, 7979);
    			attr_dev(div9, "class", "navbar svelte-yp7wdo");
    			add_location(div9, file$2, 305, 0, 6339);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*dropdowns*/ 2 && div0_class_value !== (div0_class_value = "dropdown-content " + (/*dropdowns*/ ctx[1]['#about'] ? 'show' : '') + " svelte-yp7wdo")) {
    				attr_dev(div0, "class", div0_class_value);
    			}

    			if (dirty & /*dropdowns*/ 2 && div2_class_value !== (div2_class_value = "dropdown-content " + (/*dropdowns*/ ctx[1]['#committees'] ? 'show' : '') + " svelte-yp7wdo")) {
    				attr_dev(div2, "class", div2_class_value);
    			}

    			if (dirty & /*showMenu*/ 1 && div4_class_value !== (div4_class_value = "menu-items " + (/*showMenu*/ ctx[0] ? 'show' : '') + " svelte-yp7wdo")) {
    				attr_dev(div4, "class", div4_class_value);
    			}

    			if (dirty & /*showMenu*/ 1 && div8_class_value !== (div8_class_value = "burger-menu " + (/*showMenu*/ ctx[0] ? 'active' : '') + " svelte-yp7wdo")) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			if (default_slot) default_slot.c();
    			attr_dev(div0, "class", div0_class_value = "custom-cursor " + (/*isClicking*/ ctx[0] ? 'clicking' : '') + " svelte-k0canc");
    			add_location(div0, file$1, 63, 2, 1555);
    			attr_dev(div1, "class", "hide-default-cursor svelte-k0canc");
    			add_location(div1, file$1, 62, 0, 1518);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*isClicking*/ 1 && div0_class_value !== (div0_class_value = "custom-cursor " + (/*isClicking*/ ctx[0] ? 'clicking' : '') + " svelte-k0canc")) {
    				attr_dev(div0, "class", div0_class_value);
    			}
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 31, 0, 1404);
    			add_location(style, file, 52, 0, 2216);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	(function (d, m) {
    		var kommunicateSettings = {
    			"appId": "2e8773185e779d74a646ba2969913d82b",
    			"popupWidget": true,
